...
- TransparencyPage.jsx fully translated (bug fix: was using react-i18next instead of custom useLanguage hook — fixed 2026-04-13)

## Pending Issues
- P1: Safari cursor bug (recurring 15+ times, not started)

## Backlog / Future Tasks
- P3: Refactoring of large frontend files (OTCLeads.jsx, AdminTradingPage.jsx ~1700+ lines)

## 3rd Party Integrations
- TradingView Widgets, Binance WebSockets, Revolut Business API, Trezor Connect SDK, Sumsub, Brevo, Fireblocks
