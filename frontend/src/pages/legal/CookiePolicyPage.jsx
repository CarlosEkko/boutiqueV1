...
const COOKIE_TABLE = {
  pt: [
    ...
    { name: 'kbex_tenant', purpose: 'Identificar o tenant white-label (kbex / parceiros).', duration: 'Sessão', type: 'Essencial' },
  ],
  en: [
    ...
    { name: 'kbex_tenant', purpose: 'Identifies the active white-label tenant (kbex / partners).', duration: 'Session', type: 'Essential' },
  ],
  fr: [
    ...
    { name: 'kbex_tenant', purpose: 'Identifie le tenant white-label actif.', duration: 'Session', type: 'Essentiel' },
  ],
  es: [
    ...
    { name: 'kbex_tenant', purpose: 'Identifica el tenant white-label activo.', duration: 'Sesión', type: 'Esencial' },
  ],
  ar: [
    ...
    { name: 'kbex_tenant', purpose: 'يحدد المستأجر النشط (kbex / الشركاء).', duration: 'جلسة', type: 'ضروري' },
  ],
};
