...
const menuColors = {
  ...
  cold_wallet: 'bg-slate-900/30 text-slate-400 border-slate-800/30',
  escrow: 'bg-emerald-900/30 text-emerald-400 border-emerald-800/30',
  launchpad: 'bg-violet-900/30 text-violet-400 border-violet-800/30',
};
