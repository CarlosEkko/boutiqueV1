    ...
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(
        line1Ref.current,
        {
          ...
          scale: 1.3,
          filter: 'blur(40px)',
          textShadow: '0px 0px 20px rgba(165, 122, 80, 0.4)'
        },
        {
          opacity: 1,
          scale: 1,
          filter: 'blur(0px)',
          textShadow: '0px 0px 1px rgba(165, 122, 80, 0.2)',
          duration: 1,
          ease: 'power3.out'
        }
      )
      .to(
        line1Ref.current,
        {
          ...
          scale: 0,
          filter: 'blur(50px)',
          textShadow: '0px 0px 25px rgba(165, 122, 80, 0.4)',
          duration: 0.8,
          ease: 'power3.in'
        },
        '+=1.5'
      ...
      .to(
        line2Ref.current,
        {
          ...
          scale: 0,
          filter: 'blur(50px)',
          textShadow: '0px 0px 25px rgba(255, 255, 255, 0.4)',
          duration: 0.8,
          ease: 'power3.in'
        },
        '+=1.5'
      ...
      tl.fromTo(
        line3Ref.current,
        {
          ...
          scale: 1.3,
          filter: 'blur(40px)',
          textShadow: '0px 0px 20px rgba(165, 122, 80, 0.5)'
        },
        {
          opacity: 1,
          scale: 1,
      ...
      .to(
        line3Ref.current,
        {
          ...
          scale: 0,
          filter: 'blur(50px)',
          textShadow: '0px 0px 25px rgba(165, 122, 80, 0.5)',
          duration: 0.8,
          ease: 'power3.in'
        },
        '+=1.5'
      ...
      tl.fromTo(
        line4Ref.current,
        {
          ...
          scale: 1.5,
          filter: 'blur(60px)',
          textShadow: '0px 0px 30px rgba(165, 122, 80, 0.5)'
        },
        {
          opacity: 1,
          scale: 1,
          filter: 'blur(0px)',
          textShadow: '0px 0px 2px rgba(165, 122, 80, 0.3)',
          duration: 1.2,
          ease: 'power3.out'
        },
        '-=0.3'
