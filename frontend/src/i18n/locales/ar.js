...
const TRANSLATIONS = {
  ...
  earn: {
    ...
    monthly: 'شهري',
    yearly: 'سنوي',
    aproxValue: 'القيمة التقريبية (USD)',
  ...
  institutional: {
    badge: 'حلول مؤسسية',
    title: 'بنية تحتية من',
    titleHighlight: 'الطراز المؤسسي',
    subtitle: 'وصول إلى سيولة عميقة وحفظ آمن وواجهات برمجية عالية الأداء. مصممة لصناديق التحوط ومكاتب العائلات ومديري الأصول والشركات.',
    scheduleDemo: 'جدولة عرض توضيحي',
    viewDocs: 'عرض الوثائق',
    servicesTitle: 'خدماتنا',
    otc: 'تداول خارج البورصة',
    otcDesc: 'تنفيذ صفقات كبيرة بأسعار تنافسية وسيولة عميقة.',
    otcFeature1: 'تنفيذ أوامر تبدأ من 100 ألف دولار',
    otcFeature2: 'أسعار تنافسية في الوقت الفعلي',
    otcFeature3: 'تسوية T+0',
    otcFeature4: 'دعم مخصص 24/7',
    otcFeature5: 'عملات متعددة (USD, EUR, BRL, AED)',
    custody: 'الحفظ المؤسسي',
    custodyDesc: 'تخزين آمن للأصول الرقمية مع تأمين والامتثال التنظيمي.',
    custodyFeature1: 'تخزين بارد مع HSM',
    custodyFeature2: 'تأمين يصل إلى 250 مليون دولار',
    custodyFeature3: 'تفويض متعدد التوقيعات',
    custodyFeature4: 'تدقيق SOC 2 Type II',
    custodyFeature5: 'تقارير امتثال مخصصة',
    api: 'واجهات برمجية مؤسسية',
    apiDesc: 'تكامل قوي مع REST وWebSocket للتداول الآلي.',
    apiFeature1: 'REST API بزمن استجابة < 10 ميلي ثانية',
    apiFeature2: 'WebSocket للبيانات الفورية',
    apiFeature3: 'بروتوكول FIX متاح',
    apiFeature4: 'حدود معدل مخصصة',
    apiFeature5: 'بيئة اختبار للتجارب',
    tradingVolume: 'الحجم الشهري',
    institutionalClients: 'العملاء المؤسسيون',
    uptime: 'وقت التشغيل',
    support: 'دعم مميز',
    hedgeFunds: 'صناديق التحوط',
    familyOffices: 'مكاتب العائلات',
    assetManagers: 'مديرو الأصول',
    corporations: 'الشركات',
    banks: 'البنوك',
    fintechs: 'شركات التكنولوجيا المالية',
    whoWeServe: 'من نخدم',
    whoWeServeDesc: 'حلول مخصصة لمختلف أنواع المؤسسات المالية.',
    ...
    submit: 'إرسال الطلب',
    apiTitle: 'وثائق API',
    buildWithUs: 'ابنِ مع واجهتنا البرمجية',
    apiDescription: 'واجهات RESTful وWebSocket عالية الأداء للتكامل مع أنظمة التداول لديك. وثائق كاملة ودعم فني مخصص.',
