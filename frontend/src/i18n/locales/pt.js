...
const TRANSLATIONS = {
  trade: {
    ...
    sellCta: 'Confirmar Venda',
    amountInEur: 'MONTANTE (EUR)',
    amountInAsset: 'MONTANTE',
    youReceive: 'Receberá',
    successTitle: 'Ordem submetida',
    successMsg: 'A sua ordem foi enviada à mesa KBEX.',
    errorTitle: 'Falha na ordem',
    disclaimer: 'Ordem enviada à mesa KBEX para confirmação.',
  },
  orders: {
    title: 'Ordens',
    empty: 'Ainda sem ordens',
  },
  home: {
    greeting: 'Bem-vindo de volta',
    portfolio_value: 'Valor Total',
    fiat_wallets: 'fiat',
    no_wallets: 'Ainda sem carteiras fiat',
    no_crypto: 'Ainda sem ativos cripto',
    ...
    view_all: 'Ver tudo',
    otc_sub: 'Block trades · Operações privadas',
    coming_m4: 'Disponível em breve',
  },
  portfolio: {
    fiat: 'Carteiras Fiat',
    crypto: 'Ativos Cripto',
    holdings: 'Posições',
    live_data: 'Dados em tempo real · puxe para atualizar',
  },
  transactions: {
    title: 'Transações',
    empty: 'Ainda sem transações',
  },
  tier23Modals: {
  ...
  markets: {
    searchPh: 'Procurar ativo…',
    empty: 'Sem mercados disponíveis',
    ...
    buy: 'Comprar',
    sell: 'Vender',
    simulated_trend: 'Tendência 24h (simulada)',
    note_quote: 'Cotação atualiza ao abrir',
    title: 'Mercados',
  ...
  alerts: {
    ...
    direction: 'Notificar quando o preço estiver',
    above: 'Acima',
    below: 'Abaixo',
    targetPrice: 'Preço Objetivo',
    fromCurrent: 'do preço atual',
    create: 'Criar Alerta',
    empty: 'Sem alertas configurados',
    emptyHint: 'Abra um mercado e toque em "Definir Alerta" para receber notificação push quando o preço atingir o seu objetivo.',
    sectionActive: 'Ativos',
    sectionTriggered: 'Disparados',
  ...
  wallet: {
    ...
    showZeros: 'Mostrar zeros',
    hideZeros: 'Esconder zeros',
    allZerosHint: 'Todos os ativos estão a zero. Toque acima para mostrar.',
    empty: 'Sem ativos. Faça o seu primeiro depósito.',
    liveData: 'Dados em tempo real · puxe para atualizar',
  },
  deposit: {
    title: 'Depositar Cripto',
    chooseAsset: 'Escolha o Ativo',
    change: 'Alterar',
    generating: 'A gerar endereço seguro…',
    depositAddress: 'Endereço de Depósito',
    copy: 'Copiar',
    copied: 'Copiado!',
    share: 'Partilhar',
    shareTitle: 'Endereço de Depósito',
    warningTitle: 'Atenção',
    warning1: 'Envie apenas {{asset}} via rede {{network}} para este endereço.',
    warning2: 'Depósitos noutra rede serão perdidos definitivamente.',
    confirmations: 'O saldo aparece após confirmações na rede (~10-30 min)',
  },
  withdraw: {
    title: 'Levantar Cripto',
    chooseAsset: 'Escolha o Ativo',
    change: 'Alterar',
    available: 'Disponível',
    ...
    max: 'MAX',
    note: 'Nota (opcional)',
    notePh: 'Referência interna…',
    continue: 'Continuar',
    reviewTitle: 'Confirmar Levantamento',
    reviewSubtitle: 'Verifique os detalhes antes de submeter para aprovação.',
    asset: 'Ativo',
    confirm: 'Confirmar Pedido',
    edit: 'Editar',
    exceedsBalance: 'Montante excede o saldo disponível.',
    warningTitle: 'Atenção',
    warning1: 'Os pedidos de levantamento requerem aprovação manual da equipa de compliance da KBEX.',
    warning2: 'Verifique o endereço — transferências on-chain são irreversíveis.',
    notifyHint: 'Será notificado por push quando o pedido for aprovado.',
    submittedTitle: 'Pedido submetido',
    submittedMsg: 'O seu pedido de levantamento aguarda aprovação.',
    errorTitle: 'Erro',
  },
  earn: {
    flexible: 'Flexível',
  ...
  billing: {
    ...
    paid: 'Pago',
    pending: 'Pendente',
    noHistory: 'Ainda não tem histórico de pagamentos de cobrança.',
    feeAdmission: 'Admissão',
    feeAnnual: 'Renovação',
    feeUpgrade: 'Upgrade',
  },
  business: {
    title: 'Contas Empresariais',
    addAccount: 'Abrir Conta Business',
    description: 'Abra uma conta empresarial para operar em nome da sua empresa. Cada conta tem carteiras e limites independentes.',
    noAccounts: 'Ainda não tem contas empresariais',
    newAccount: 'Nova Conta Empresarial',
  },
  demoMode: {
    title: 'Modo Demo',
    description: 'Ativar dados simulados para demonstração',
  },
};
