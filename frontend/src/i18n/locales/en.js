...
const TRANSLATIONS = {
  ...
  sidebar: {
    ...
    cotacoes: 'Quotes',
    execucao: 'Execution',
    mesaInstitucional: 'Institutional Desk',
  ...
  withdraw: {
    ...
    max: 'MAX',
    note: 'Note (optional)',
    notePh: 'Internal reference…',
    continue: 'Continue',
    reviewTitle: 'Confirm Withdrawal',
    reviewSubtitle: 'Review the details before submitting for approval.',
    asset: 'Asset',
    confirm: 'Confirm Request',
    edit: 'Edit',
    exceedsBalance: 'Amount exceeds available balance.',
    warningTitle: 'Warning',
    warning1: 'Withdrawal requests require manual approval from the KBEX compliance team.',
    warning2: 'Double-check the address — on-chain transfers are irreversible.',
    notifyHint: 'You will be notified by push when the request is approved.',
    submittedTitle: 'Request submitted',
    submittedMsg: 'Your withdrawal request is awaiting approval.',
    errorTitle: 'Error',
  },
  earn: {
    flexible: 'Flexible',
  ...
  institutional: {
    ...
    phone: 'Phone',
    available247: '24/7 for clients',
    emailContact: 'Email',
    responseTime: 'Reply within 2h',
    liveChat: 'Priority Chat',
  ...
  billing: {
    ...
    paid: 'Paid',
    pending: 'Pending',
    noHistory: 'No billing payment history yet.',
  ...
  business: {
    ...
    addAccount: 'Open Business Account',
    description: 'Open a business account to operate on behalf of your company. Each account has independent wallets and limits.',
    noAccounts: "You don't have any business accounts yet",
    newAccount: 'New Business Account',
  },
  demoMode: {
    title: 'Demo Mode',
    description: 'Enable simulated data for demonstration',
  },
};
