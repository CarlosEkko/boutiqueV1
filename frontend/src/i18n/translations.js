...
const translations = {
  ...
  AR: {
    ...
    products: {
      ...
      premiumExchange: 'منصة التداول المتميزة',
      premiumExchangeDesc: 'مكتب تداول OTC متميز مع مديري علاقات مخصصين. تنفيذ صفقات كبيرة الحجم بسيولة مؤسسية وسرية.',
      cryptoAtm: 'شبكة صرافات العملات المشفرة',
      cryptoAtmDesc: 'شبكة منتقاة من صرافات العملات المشفرة في مواقع حصرية. تحويلات سلسة من العملات الورقية إلى المشفرة.',
      launchpad: 'منصة الإطلاق',
      launchpadDesc: 'وصول مبكر لمشاريع البلوكتشين المختارة. المشاركة في فرص استثمارية حصرية.',
      custody: 'الحفظ المؤسسي',
      custodyDesc: 'أمان بمستوى عسكري لتخزين الأصول الرقمية. محافظ متعددة التوقيع وتغطية تأمينية.'
    },
